...
public class BellmenFordsShortestPathTest {

    BellmenFordsShortestPath bellmenFordsShortestPath = new BellmenFordsShortestPath();
    ...
    public void shortestPath_unweighted() {
        ...
        double i = bellmenFordsShortestPath.shortestPath(graph1, 1, 7);
    ...
    public void shortestPath_positive_DIRECTED() {
        ...
        double i = bellmenFordsShortestPath.shortestPath(graph, 4, 3);
...
//        graph.addEdge(4, 0,3);
    ...
    public void shortestPath_positive_DIRECTED_negative_weights() {
        ...
        double i = bellmenFordsShortestPath.shortestPath(graph, 4, 3);
        assertEquals(0, Double.compare(Double.NEGATIVE_INFINITY, i));
    }
...
//        graph.addEdge(3, 2, 2);
        ...
        double i = bellmenFordsShortestPath.shortestPath(graph, 0, 1);
